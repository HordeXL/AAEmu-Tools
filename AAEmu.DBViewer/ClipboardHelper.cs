...
namespace AAEmu.ClipboardHelper
{
            ...
            catch (Exception ex)
            {
                ...
                else
                {
                    ...
                    catch
                    {
                        ...
                        System.Windows.Forms.MessageBox.Show(ex.Message, "复制到剪贴板", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
